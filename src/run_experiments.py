...
def main(experiments_dir, log_dir, recover=True, force=False,
         display_logs=True):
    os.makedirs(log_dir, exist_ok=True)

    config_files = sorted(os.listdir(experiments_dir))
    for config_file in config_files:
        config_file_path = os.path.join(experiments_dir, config_file)
